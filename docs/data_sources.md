...
### 3. Machine Learning Extracted Features
...
- Feature extraction: Machine learning pipeline described in [methodology.md].
```
...
See also: [user_guide.md](user_guide.md), [methodology.md](methodology.md)
